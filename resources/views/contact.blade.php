...
@section('content')
<h1 class="text-center p-4 m-4">CONTACT</h1>
...
<form method="post" action="{{route('contact.envoi')}}">

    @csrf

    <div class="container text-center m-4">
        <div class="row">
            <h1 class="contactus pt-4 m-4">Contactez-nous</h1>
          <div class="col-3">
          </div>
          <div class="col-6">
            <div class="form-group row">
                ...
                <div class="col">
                    <input name="name"type="text" class="form-control m-4" id="inputnom" placeholder="Nom" required>
                </div>
            </div>
            @error('nom')
            ...
            <div class="form-group row">
                ...
                <div class="col">
                    <input name="phone"type="number" class="form-control m-4" id="inputtel" placeholder="Telephone" required>
                </div>
            </div>
            @error('phone')
                <span class="text-danger">{{ $message }}</span>
